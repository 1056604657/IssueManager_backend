# Generated by Django 3.2 on 2024-01-17 15:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(help_text='键值', max_length=64, verbose_name='键值')),
                ('ding_webhook', models.CharField(default='', help_text='钉钉webhook', max_length=255, verbose_name='钉钉webhook')),
                ('remark', models.CharField(blank=True, help_text='备注', max_length=2000, null=True, verbose_name='备注')),
                ('creator', models.ForeignKey(db_constraint=False, help_text='创建人', null=True, on_delete=django.db.models.deletion.SET_NULL, related_query_name='creator_query', to=settings.AUTH_USER_MODEL, verbose_name='创建人')),
                ('manager', models.ForeignKey(help_text='负责人', on_delete=django.db.models.deletion.CASCADE, related_name='jira_projects', to=settings.AUTH_USER_MODEL, verbose_name='负责人')),
            ],
            options={
                'verbose_name': '项目表',
                'verbose_name_plural': '项目表',
                'db_table': 'dvadmin_jira_project',
                'ordering': ('-create_datetime',),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_datetime', models.DateTimeField(auto_now=True, help_text='修改时间', null=True, verbose_name='修改时间')),
                ('create_datetime', models.DateTimeField(auto_now_add=True, help_text='创建时间', null=True, verbose_name='创建时间')),
                ('name', models.CharField(help_text='主题', max_length=255, verbose_name='主题')),
                ('signal_number', models.CharField(help_text='标识', max_length=255, verbose_name='标识')),
                ('description', models.TextField(blank=True, help_text='描述', null=True, verbose_name='描述')),
                ('attachments', models.CharField(blank=True, help_text='附件', max_length=255, null=True, verbose_name='附件')),
                ('type', models.IntegerField(choices=[(1, '操作体验'), (2, '功能错误'), (3, '功能缺失'), (4, '数据中断'), (5, '性能问题'), (6, '其他')], default=6, help_text='类型', verbose_name='类型')),
                ('status', models.IntegerField(choices=[(1, '进行中'), (2, '已解决')], default=1, help_text='状态', verbose_name='状态')),
                ('priority', models.IntegerField(choices=[(1, 'P1'), (2, 'P2'), (3, 'P3'), (4, 'P4'), (5, 'P5')], default=2, help_text='优先级', verbose_name='优先级')),
                ('source', models.IntegerField(choices=[(1, '客户提出'), (2, '内部人员发现')], default=1, help_text='来源', verbose_name='来源')),
                ('deadline', models.DateTimeField(blank=True, help_text='截至日期', null=True, verbose_name='截至日期')),
                ('resolve_datetime', models.DateTimeField(blank=True, help_text='解决日期', null=True, verbose_name='解决日期')),
                ('assigned', models.ForeignKey(help_text='指派人', on_delete=django.db.models.deletion.CASCADE, related_name='jira_issue', to=settings.AUTH_USER_MODEL, verbose_name='指派人')),
                ('creator', models.ForeignKey(db_constraint=False, help_text='创建人', null=True, on_delete=django.db.models.deletion.SET_NULL, related_query_name='creator_query', to=settings.AUTH_USER_MODEL, verbose_name='创建人')),
                ('project', models.ForeignKey(help_text='所属项目', on_delete=django.db.models.deletion.CASCADE, related_name='jira_issue', to='system.jiraproject', verbose_name='所属项目')),
            ],
            options={
                'verbose_name': 'issue表',
                'verbose_name_plural': 'issue表',
                'db_table': 'dvadmin_jira_issue',
                'ordering': ('-create_datetime',),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_datetime', models.DateTimeField(auto_now=True, help_text='修改时间', null=True, verbose_name='修改时间')),
                ('create_datetime', models.DateTimeField(auto_now_add=True, help_text='创建时间', null=True, verbose_name='创建时间')),
                ('body', models.TextField(blank=True, help_text='描述', null=True, verbose_name='描述')),
                ('author', models.ForeignKey(help_text='创建人', on_delete=django.db.models.deletion.CASCADE, related_name='issue_comment', to=settings.AUTH_USER_MODEL, verbose_name='创建人')),
                ('creator', models.ForeignKey(db_constraint=False, help_text='创建人', null=True, on_delete=django.db.models.deletion.SET_NULL, related_query_name='creator_query', to=settings.AUTH_USER_MODEL, verbose_name='创建人')),
                ('issue', models.ForeignKey(help_text='所属issue', on_delete=django.db.models.deletion.CASCADE, related_name='issue_comment', to='system.jiraissue', verbose_name='所属issue')),
            ],
            options={
                'verbose_name': 'comment表',
                'verbose_name_plural': 'comment表',
                'db_table': 'dvadmin_issue_comment',
                'ordering': ('-create_datetime',),
            },
        ),
        migrations.CreateModel(
